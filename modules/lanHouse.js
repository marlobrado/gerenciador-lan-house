...
export class LanHouse{
    ...
    addClient(client){
        ...
        console.error("❌ Erro: O objeto fornecido não é uma instância da classe Client.")
    ...
    addComputer(computer){
        ...
        console.error("❌ Erro: O objeto fornecido não é uma instância da classe Computador.")
        return
    }
}